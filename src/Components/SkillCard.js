...
const SKillCard = ({ title, imageUrl, Platform, PlatformLink, content }) => {
  return (
    <>
      <div className="flex flex-col gap-4 w-80 h-96  bg-gray-100 rounded-md transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl">
        <img
